...
sprot_data_compressed = os.path.join(output_folder, "data", config["explorenz"]["output_file"])
...
try:
    ...
    populate.uniprot(filename=sprot_pickle, database=database, database_type="sprot")
...
# trembl_data_compressed = os.path.join(output_folder, "data", config["explorenz"]["output_file"])
...
#        os.remove(file)
# try:
#    print(f"Start of trembl populating {populate.current_time()}")
