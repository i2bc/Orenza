...
# sprot_data_compressed = os.path.join(
#    output_folder, "data", config["sprot"]["output_file"]
# )
...
# download.ftp(
#    ftp_host=sprot_ftp, remote_file=sprot_remote_file, local_file=sprot_data_compressed
# )
...
# trembl_data_compressed = os.path.join(
#    output_folder, "data", config["trembl"]["output_file"]
# )
...
# parse.gunzip_file(
#    input_file=trembl_data_compressed, output_file=trembl_data_uncompressed
# )
...
## Brenda
# brenda_data_compressed = os.path.join(
#   output_folder, "data", config["brenda"]["compressed_file"]
# )
# brenda_data_uncompressed = brenda_data_compressed.replace(".tar.gz", "")
# brenda_data_uncompressed = (
#   "/data/work/I2BC/hugo.pointier/script/data/brenda_2023_1.txt/brenda_2023_1.txt"
# )
#
